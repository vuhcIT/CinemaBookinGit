...
where lichchieu.ThoiGianChieu>NOW()"
?>
<!DOCTYPE html>
<html lang="en">
...
<!-- style="background-color:grey;" -->
    ...
    <div class="admin-section-header">
        ...
        <button class="btn btn-blue" onclick="window.location.href='../testdangnhapadmin/indexadmin.php';"><i class="fa fa-home"></i> Home</button>
